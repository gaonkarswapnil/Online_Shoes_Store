...
<html>
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
        SELECT PRODUCT_IMAGE, PRODUCT_NAME, PRODUCT_TYPE, PRICE, STOCK, DESCRIPTION FROM PRODUCTS;
    </sql:query>
		...
		<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="118">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Hello Customer</a>
				</div>
		...
		<div class="container">
			<h2 class="text-center" id="mainBeverages"></h2>
			<hr>
				...
				<div class="media">
	                ...
	                <div class="media-body">			
	                    <h3 class="media-heading">${user.PRODUCT_NAME}</h3>
	                        <p>Product Name: ${user.PRODUCT_NAME}</p>
	                        <p>Description: ${user.DESCRIPTION}</p> 
	                        
	                        <p>Price: ${user.PRICE}</p>
	                        <p>Stock: ${user.STOCK}</p>
	                    <a href="login.jsp" class="btn btn-primary">BUY</a>
	                </div>
	            </div>
	            <hr>
            </c:forEach>
